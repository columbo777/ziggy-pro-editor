...
using ZipLib.SharpZipLib.Encryption;
#endif

using ZipLib.SharpZipLib.Core;
using ZipLib.SharpZipLib.Checksums;
using ZipLib.SharpZipLib.Zip.Compression.Streams;
using ZipLib.SharpZipLib.Zip.Compression;

namespace ZipLib.SharpZipLib.Zip
{
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        /// </exception>
        /// <exception cref="ZipLib.SharpZipLib.Zip.ZipException">
